...
<header data-bs-theme="dark">
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          <h4>A Propos</h4>
          <p class="text-body-secondary">Dans le cadre de la ressource R3.01-Développement Web, nous avons réaliser ce site PHP simulant un site de vente de CD.</p>
        </div>
        <div class="col-sm-4 offset-md-1 py-4">
          <h4>Contacts</h4>
          <ul class="list-unstyled">
            <li><a href="https://github.com/MaxMontouro/r3_01_projet" class="text-white">Dépot Github</a><img src="./img/github.png" width="40" height="40" style="margin-left: 10px;"></a></li>
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      ...
      <img src="./img/vinyl.gif" width="100" height="100" style="margin-right: 20px;">
        <strong>VINYLOG</strong>
      </a>
